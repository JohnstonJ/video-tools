...
def test_title_timecode_binary(tc: PackBinaryTestCase) -> None:
    test_dif_pack.run_pack_binary_test_case(tc, pack.TitleTimecode)
...
def test_vaux_recording_time_binary(tc: PackBinaryTestCase) -> None:
    test_dif_pack.run_pack_binary_test_case(tc, pack.VAUXRecordingTime)
...
def test_aaux_recording_time_binary(tc: PackBinaryTestCase) -> None:
    test_dif_pack.run_pack_binary_test_case(tc, pack.AAUXRecordingTime)
